...
<table class="tabla">
	<tr>
		...
		<td class="sesion">
			...
			include("../model/usuario_sesion.php");
...
<header>
	...
	<label for="btn-menu"><img src="../images/menu.png">
		...
		<nav class="menu">
			<ul>
				<li><a href="../controler/usuario_controler_1.php">Inicio</a></li>
				<li><a href="../controler/usuario_controler_2.php">Mis Activos</a></li>
				<li><a href="../controler/usuario_controler_3.php">Actualizar Datos</a></li>
			</ul>
		</nav>
</header>
<br>
